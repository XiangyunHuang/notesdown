...
默认的 PDF 文档 [PDF 文档案例](https://github.com/XiangyunHuang/notesdown/blob/master/examples/pdf-default.Rmd)

详见[PDF 文档案例](https://github.com/XiangyunHuang/notesdown/blob/master/examples/pdf-document.Rmd)
...
[参数化文档案例](https://github.com/XiangyunHuang/notesdown/blob/master/examples/parameterized-document.Rmd)
...
beamer 幻灯片也是一种 PDF 文档 [PDF 文档案例](https://github.com/XiangyunHuang/notesdown/blob/master/examples/beamer-verona.Rmd)
