...
```{r other-ts, fig.cap="时间序列：非平稳、周期性、非线性", fig.subcap=c("1960-1980年强生公司每股季度收益", "1949-1960年月均航班乘客数量", "1920-1939 年诺丁汉月均气温", "1821-1934 年加拿大山猫陷阱数量"), fig.ncol=2,fig.width=8,fig.height=6,fig.show='hold', out.width="45%"}
plot(JohnsonJohnson)
plot(AirPassengers)
plot(nottem)
plot(lynx)
