...
```
```{r, echo=knitr::is_html_output(), eval=knitr::is_html_output(), fig.cap="港股走势"}
highchart(type = "stock") %>% 
  hc_add_series(meituan, type = "ohlc") %>% 
  hc_add_series(ali, type = "ohlc") %>% 
  hc_add_series(sw, type = "ohlc") %>% 
  hc_add_series(tx, type = "ohlc")
```
...
```
```{r, echo=knitr::is_html_output(), eval=knitr::is_html_output(), fig.cap="美股走势"}
highchart(type = "stock") %>% 
  hc_add_series(pdd, type = "ohlc") %>% 
  hc_add_series(jd, type = "ohlc") %>% 
  hc_add_series(baba, type = "ohlc") %>% 
