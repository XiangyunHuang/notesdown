...
```{r,eval=knitr::is_html_output() & !is.na(Sys.getenv('CI', NA)),fig.cap="疫情期间51Talk公司的股价走势",echo=knitr::is_html_output()}
highchart(type = "stock") %>% 
   hc_add_series(coe, type = "ohlc")
```
```{r,eval=knitr::is_latex_output() & !is.na(Sys.getenv('CI', NA)),fig.cap="疫情期间51Talk公司的股价走势",echo=knitr::is_latex_output()}
plot(coe[, "COE.Close"],
