...
```{r name-capture, fig.cap="命名捕捉", echo=FALSE}
knitr::include_graphics(path = "screenshots/regexp-name-capture.png")
```
...
```{r regex-xkcd, fig.cap="正则表达式漫画", fig.link="https://imgs.xkcd.com/comics/regular_expressions.png", echo=FALSE}
knitr::include_graphics(path = "screenshots/regexp-comics.png")
```
