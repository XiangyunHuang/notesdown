...
老师：
   ...
   您好！感谢您为《现代统计图形》写推荐语，人民邮电出版社通知我们书籍即将出版，为表达感谢，赠送您一本书。谢益辉让我收集您的**国内**收件地址和联系方式，以便出版社投递，如您方便，烦请告知，再次感谢！
...
网站：<https://xiangyun.rbind.io/>
")
)

smtp_send(
  from = c("黄湘云" = "xiangyunfaith@outlook.com"), # 发件人
  to = c("黄湘云" = "xiangyunfaith@outlook.com"),
  bcc = c(
    "黄湘云" = "xiangyunfaith@outlook.com"
    ),
  subject = "感谢您为《现代统计图形》写推荐语",
  email = email,
...
smtp_send(
  from = c("黄湘云" = "xiangyunfaith@outlook.com"), # 发件人
  to = c("黄湘云" = "xiangyunfaith@outlook.com", 
         "黄湘云" = "xiangyunfaith@gmail.com"),
  bcc = c(
    "赵彦云" = "cas-kriu@ruc.edu.cn",
    "李丰" = "feng.li@cufe.edu.cn",
    "李舰" = "jian.li@188.com",
    "吴喜之" = "xizhi_wu@163.com",
    "魏太云" = "taiyun.wei@foxmail.com",
    "肖楠" = "road2stat@gmail.com",
    "王星" = "wangxing@ruc.edu.cn",
    "李承文" = "15811392189@163.com",
    "李东风" = "ldfwyn@163.com",
    "姜晓东" = "jxd@hunnu.edu.cn",
    "邱怡轩" = "yixuan.qiu@cos.name",
    "张列弛" = "nibb.liechi@gmail.com",
    "刘思喆" = "sunbjt@gmail.com",
    "袁晓如" = "xiaoru.yuan@gmail.com",
    "叶飞"   = "fyemath@gmail.com",
    "夏骁凯" = "xia@xiaokai.me",
    "曹洋" = "yiluheihei@gmail.com",
    "姜军" = "jiangjun12321@gmail.com"
    ),
  subject = "感谢您为《现代统计图形》写推荐语",
  email = email,
  credentials = creds_key(id = "outlook")
...
email <- compose_email(
  body = md("
来信已经收到，出版社预计几天内将书寄出，如遇问题，请随时联系我，感谢！
")
)
# 发送邮件
smtp_send(
  from = c("黄湘云" = "xiangyunfaith@outlook.com"),
  to = c("黄湘云" = "xiangyunfaith@outlook.com"),
  bcc = c(
    "赵彦云" = "cas-kriu@ruc.edu.cn",
    "李丰" = "feng.li@cufe.edu.cn",
