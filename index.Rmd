...
x = seq(from = -3, to = 6, length.out = 301)
y = dnorm(x, mean = 0, sd = 1)
yy = dnorm(x, mean = 1, sd = 1.5)
library(magrittr)
...
plotly::plot_ly(
  ...
  mode = "lines", name = plotly::TeX("\\mathcal{N}(0,1)"),
  ...
  plotly::add_trace(
    ...
    mode = "lines", name = plotly::TeX("\\mathcal{N}(1,1.5^2)"),
  ...
  plotly::add_annotations(
    x = 4, y = 1 / (1.5 * sqrt(2 * pi)), font = list(size = 100), showarrow = F,
