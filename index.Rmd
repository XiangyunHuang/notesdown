...
geometry:
  ...
  - lmargin=3.0cm
  - rmargin=2.0cm
classoption: "UTF8,twoside,openany,fontset=adobe"
bibliography: 
  - book.bib
  - packages.bib
link-citations: yes
...
# 近似计算 Wilson 区间
prop.test(x = 2, n = 10, p = 0.95, conf.level = 0.95)
# 精确计算
...
```{r r-eco-system, engine = "tikz", echo=FALSE, fig.cap = "R 语言扩展包生态系统", cache=TRUE, fig.ext=ifelse(knitr::is_latex_output(), 'pdf', 'png')}
...
```{r workflow, echo=FALSE, fig.cap="书籍项目架构图"}
DiagrammeR::grViz("
digraph {
