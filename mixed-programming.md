...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7f3f7edae790>]
plt.show()
```
...
## gcc -I"/opt/R/4.1.1/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c70def1b8354.c -o c70def1b8354.o
## gcc -shared -L/opt/R/4.1.1/lib/R/lib -L/usr/local/lib -o c70def1b8354.so c70def1b8354.o -L/opt/R/4.1.1/lib/R/lib -lR
