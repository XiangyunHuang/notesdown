...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7fb2957b9eb0>]
plt.show()
```
...
## gcc -I"/opt/R/4.1.0/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c4ebdab37803.c -o c4ebdab37803.o
## gcc -shared -L/opt/R/4.1.0/lib/R/lib -L/usr/local/lib -o c4ebdab37803.so c4ebdab37803.o -L/opt/R/4.1.0/lib/R/lib -lR
