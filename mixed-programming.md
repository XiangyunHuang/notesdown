...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7f11cc0b7e80>]
plt.show()
```
...
## gcc -I"/opt/R/4.0.3/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c493838c78095.c -o c493838c78095.o
## gcc -shared -L/opt/R/4.0.3/lib/R/lib -L/usr/local/lib -o c493838c78095.so c493838c78095.o -L/opt/R/4.0.3/lib/R/lib -lR
...
##  [9] tools_4.0.3       grid_4.0.3        xfun_0.23         png_0.1-7        
## [13] jquerylib_0.1.4   htmltools_0.5.1.1 ellipsis_0.3.2    yaml_2.2.1       
## [17] digest_0.6.27     lifecycle_1.0.0   bookdown_0.22     Matrix_1.3-3     
## [21] later_1.2.0       sass_0.4.0        promises_1.2.0.1  evaluate_0.14    
## [25] mime_0.10         rmarkdown_2.8     stringi_1.6.2     compiler_4.0.3   
## [29] bslib_0.2.5       jsonlite_1.7.2    httpuv_1.6.1
```
