...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7fca35150eb0>]
plt.show()
```
...
## gcc -I"/opt/R/4.1.0/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c8a6d35a034f3.c -o c8a6d35a034f3.o
## gcc -shared -L/opt/R/4.1.0/lib/R/lib -L/usr/local/lib -o c8a6d35a034f3.so c8a6d35a034f3.o -L/opt/R/4.1.0/lib/R/lib -lR
