...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7f4b51fbf730>]
plt.show()
```
...
## gcc -I"/opt/R/4.1.0/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c567437661531.c -o c567437661531.o
## gcc -shared -L/opt/R/4.1.0/lib/R/lib -L/usr/local/lib -o c567437661531.so c567437661531.o -L/opt/R/4.1.0/lib/R/lib -lR
