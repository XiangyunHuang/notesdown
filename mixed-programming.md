...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7fca887a24c0>]
plt.show()
```
...
## gcc -I"/opt/R/4.1.1/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c641e264a8556.c -o c641e264a8556.o
## gcc -shared -L/opt/R/4.1.1/lib/R/lib -L/usr/local/lib -o c641e264a8556.so c641e264a8556.o -L/opt/R/4.1.1/lib/R/lib -lR
