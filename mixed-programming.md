...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7f1b2cb33400>]
plt.show()
```
...
## gcc -I"/opt/R/4.1.0/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c57072b7ddd1a.c -o c57072b7ddd1a.o
## gcc -shared -L/opt/R/4.1.0/lib/R/lib -L/usr/local/lib -o c57072b7ddd1a.so c57072b7ddd1a.o -L/opt/R/4.1.0/lib/R/lib -lR
