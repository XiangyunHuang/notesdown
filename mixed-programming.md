...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7f661ae014c0>]
plt.show()
```
...
## gcc -I"/opt/R/4.1.1/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c63824fd1b824.c -o c63824fd1b824.o
## gcc -shared -L/opt/R/4.1.1/lib/R/lib -L/usr/local/lib -o c63824fd1b824.so c63824fd1b824.o -L/opt/R/4.1.1/lib/R/lib -lR
