...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7f74de93b400>]
plt.show()
```
...
## gcc -I"/opt/R/4.1.0/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c56b578beab1f.c -o c56b578beab1f.o
## gcc -shared -L/opt/R/4.1.0/lib/R/lib -L/usr/local/lib -o c56b578beab1f.so c56b578beab1f.o -L/opt/R/4.1.0/lib/R/lib -lR
