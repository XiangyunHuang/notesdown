...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7f7c372a83d0>]
plt.show()
```
...
## gcc -I"/opt/R/4.1.0/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c5a7e7bba1fc8.c -o c5a7e7bba1fc8.o
## gcc -shared -L/opt/R/4.1.0/lib/R/lib -L/usr/local/lib -o c5a7e7bba1fc8.so c5a7e7bba1fc8.o -L/opt/R/4.1.0/lib/R/lib -lR
