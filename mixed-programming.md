...
plt.plot([0, 2, 1, 4])
## [<matplotlib.lines.Line2D object at 0x7f3492eaf6d0>]
plt.show()
```
...
## gcc -I"/opt/R/4.1.0/lib/R/include" -DNDEBUG   -I/usr/local/include   -fpic  -g -O2  -c c592939ecd170.c -o c592939ecd170.o
## gcc -shared -L/opt/R/4.1.0/lib/R/lib -L/usr/local/lib -o c592939ecd170.so c592939ecd170.o -L/opt/R/4.1.0/lib/R/lib -lR
