...
除之前提到的 grDevices 包[@R-base] 、colorspace 包 [@R-colorspace]和 RColorBrewer 包 [@R-RColorBrewer] 之外，此处还收录 yarrr 包 、dichromat 包、colormap 包、viridis 包、pals 包 、ColorPalette 包、colorRamps包、colortools包 ，此外还有 palr 包 就不一一详细介绍了。
