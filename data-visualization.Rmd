...
```{r boxplot-violin,fig.cap="几种不同的提琴图",fig.width=4,fig.height=4,out.width="45%",fig.show='hold',fig.ncol=2,fig.subcap=c("简单箱线图", "vioplot 绘制的提琴图", "ggplot2 绘制的提琴图", "beanplot 绘制的提琴图")}
...
library(beanplot)
beanplot(count ~ spray, data = InsectSprays, col = "lightgray")
```
