...
Winston Chang 将 Paul Murrell 的 Computer Modern 字体文件打包成 [fontcm](https://github.com/wch/fontcm) 包 [@fontcm]，fontcm 包可以在 Base R 图形中嵌入数学字体 [^cmr-fonts]，图形中嵌入重音字符 [^accent-fonts]。下面先下载、安装、加载字体，
