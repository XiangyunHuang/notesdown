...
p4 <- p1 + labs(
  ...
  theme(
    axis.title = element_text(family = "source-han-serif-cn"),
    axis.text.x = element_text(family = "DejaVu Serif"),
    axis.text.y = element_text(family = "DejaVu Sans"),
    title = element_text(family = "source-han-serif-cn"),
    plot.subtitle = element_text(family = "DejaVu Sans", size = rel(0.7)),
    plot.caption = element_text(family = "DejaVu Sans", size = rel(0.6))
  ) +
