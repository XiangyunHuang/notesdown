...
```{r font-in-ggplot, fig.width=6, fig.height=6, fig.showtext=TRUE, fig.cap="在 ggplot2 绘图系统中设置中英文字体", out.width="85%"}
...
```{r boxplot-facet-color-clarity-2,fig.cap="箱线图配色",fig.cap=c("切割质量cut上色","钻石颜色配色"),fig.ncol=1}
