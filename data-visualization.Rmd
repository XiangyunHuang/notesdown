...
组合的意思是将不同种类的图形绘制在一个区域中，比如密度曲线和地毯图组合。
[**GGally**](https://github.com/ggobi/ggally)、 [**ggupset**](https://github.com/const-ae/ggupset) 和 [**ggpubr**](https://github.com/kassambara/ggpubr) 高度定制了一些组合统计图形，以 ggpubr 为例，见图 \@ref(ggpubr-composite)

```{r ggpubr-composite,fig.cap="组合图形",fig.width=6,fig.width=4}
library(ggpubr)
ggdensity(sleep,
