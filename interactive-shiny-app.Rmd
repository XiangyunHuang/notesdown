...
```{r shiny-nomnoml, eval=FALSE, echo=FALSE}
# 截图
...
", png = "shiny-app.png")
```
```{r shiny-ecosystem, fig.cap="Shiny 生态系统", echo=FALSE}
...
```{r shiny-org,fig.cap="开发 Shiny 应用扩展的组织",echo=FALSE,out.width="75%"}
knitr::include_graphics(path = "diagrams/shiny-org.png")
```
