...
第三方 R 包大大扩展了 Base R 函数 `plot()` 的功能，比如 nlme 包和 lattice 包等。

```{r generic-function,echo=FALSE}
knitr::kable(matrix(methods("plot"), ncol = 3), "pandoc", caption = "泛型函数")
```
