...
function Div(el)
  ...
  if el.classes:includes("rmdwarn") then
    return {
      pandoc.RawBlock("latex", "\\begin{rmdwarn}\\textcolor[RGB]{255,83,59}{\\textbf{警告}}"),
      el,
  ...
  if el.classes:includes("rmdnote") then
    return {
      pandoc.RawBlock("latex", "\\begin{rmdnote}\\textcolor[RGB]{251,188,5}{\\textbf{注意}}"),
      el,
  ...
  if el.classes:includes("rmdtip") then
    return {
      pandoc.RawBlock("latex", "\\begin{rmdtip}\\textcolor[RGB]{81,183,73}{\\textbf{提示}}"),
      el,
