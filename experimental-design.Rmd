...
推荐读者使用贴合 R 语言的试验设计入门书 《Design and Analysis of Experiments with R》[@Lawson2014]，作者提供相应的 R 包 [daewr](https://cran.r-project.org/package=daewr) 打包了该书的数据和代码。另一本推荐的读物是 《Statistics for Experimenters: Design, Innovation, and Discovery》[@Box2005]
