...
```{r feasible-region,echo=TRUE,fig.cap="可行域",fig.width=4.5,fig.height=4}
plot(0, 0,
...
```{r toy-binary,fig.width=4.5,fig.height=4,fig.cap="二分类问题"}
library(kernlab)
set.seed(123)
...
```{r himmelblau,fig.cap="Himmelblau 函数图像",fig.width=4.5,fig.height=4}
