...
[Presto](https://github.com/prestodb/presto) 的 R 接口 <https://github.com/prestodb/RPresto> 和文档 <https://prestodb.io/docs/current/index.html>，
...
借助 `spark_install()` 安装 Spark，比如下面 Spark 3.0 连同 hadoop 2.7 一起安装
...
先设置 SPARK_HOME 环境变量，连接本地单机版 Spark
...
SparkR 包 <https://spark.apache.org/docs/latest/sparkr.html#running-sql-queries-from-sparkr>
...
# 下载 Spark 软件环境，此环境自带 R 和 Python 接口
