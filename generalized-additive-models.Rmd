...
- **mgcv** [@Wood_2017_Generalized]  [**mgcViz**](https://github.com/mfasiolo/mgcViz)[@mgcViz] 模型开发和结果呈现
- **gss** [@Gu_2014_jss]
- **mda** [@mda]
...
library(ISLR)
Income <- read.table("https://www.statlearning.com/s/Income2.csv", sep = ",", header = TRUE)
...
# 绘图
point_pmat <- persp(
  x = x_Edu, y = x_Sen, z = y_income, 
  theta = 45, phi = 35, col = "lightblue", border = "blue",
