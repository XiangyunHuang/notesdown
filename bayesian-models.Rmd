...
[cmdstanr](https://github.com/stan-dev/cmdstanr) 相比于 rstan 将会更加轻量，更快地将 CmdStan 的新功能融入进来，方便用户滚动升级。做贝叶斯计算的软件框架还包括 JAGS 和 WinBUGS，苏毓松开发的 R2jags 包 [@R-R2jags] 是 JAGS 的 R 接口。
