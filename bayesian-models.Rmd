...
<!-- [shinybrms](https://github.com/fweber144/shinybrms) 贝叶斯模型求解器，基于 shiny，Stan 写模型，模型库，编译好供大家调用，用 shiny 包装好，
brms/rstan 的后端为 cmdstanr，代码版本管理，模型库管理，软件环境管理 -->
...
[rstan](https://github.com/stan-dev/rstan) [brms](https://github.com/paul-buerkner/brms)  [shinybrms](https://github.com/fweber144/shinybrms)
