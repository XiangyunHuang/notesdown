...
```bash
./configure --prefix=/opt/R/R-devel  --enable-R-shlib --enable-byte-compiled-packages \
...
sudo dnf copr enable/disable simc/stable # 获取 gdal-devel
...
#### 清理升级后的 CentOS 8 系统内核 {#clean-old-kernels}
