...
从 <https://github.com/settings/tokens> 新建拥有 GitHub Package [^github-package] 读写删的权限的 TOKEN（俗称访问令牌或密钥），命名为 `GITHUB_PKG` 
...
# 容器内的信息
docker run --rm -u root -v "/${PWD}://home/docker/" --name=masr-book docker.pkg.github.com/xiangyunhuang/masr/masr-book:devel bash -c "locale; fc-list | sort"
```
