...
## 'Noto Serif SC' not found, will use 'sans' instead
...
## family 'Noto Serif SC' not found, will use 'wqy-microhei' instead
```

```
## Warning in grid.Call(C_textBounds, as.graphicsAnnot(x$label), x$x, x$y, : font
## family 'Noto Serif SC' not found, will use 'sans' instead
```
...
## font family 'Noto Serif SC' not found, will use 'sans' instead
...
```
## Warning in grid.Call.graphics(C_text, as.graphicsAnnot(x$label), x$x, x$y, :
## font family 'Noto Serif SC' not found, will use 'wqy-microhei' instead
...
\caption{HCL调色}(\#fig:unnamed-chunk-27)
\end{figure}
...
\caption{直方图}(\#fig:unnamed-chunk-31)
\end{figure}
...
\caption{局部多项式平滑}(\#fig:unnamed-chunk-37)
\end{figure}
...
\caption{多个图例}(\#fig:unnamed-chunk-38)
\end{figure}
...
\caption{1948年至1960年航班乘客人数变化}(\#fig:unnamed-chunk-39)
\end{figure}
...
\caption{钻石价格的分布}(\#fig:unnamed-chunk-44)
\end{figure}
...
\caption{钻石价格随切割质量的分布}(\#fig:unnamed-chunk-45)
\end{figure}
...
\caption{条件密度估计图}(\#fig:unnamed-chunk-48)
\end{figure}
...
\caption{抖动图的反例}(\#fig:unnamed-chunk-56)
\end{figure}
...
\caption{根据钻石颜色上色}(\#fig:unnamed-chunk-57)
\end{figure}
